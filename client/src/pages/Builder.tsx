...
import { Sparkles, Save, Plus, Trash2, Loader2, ArrowLeft, Wand2, FileText, Eye } from "lucide-react";
      ...
      <div className="flex-1 grid grid-cols-[260px_1fr_360px] min-h-0">
        ...
        <aside className="border-l border-zinc-800 bg-zinc-900/30 flex flex-col min-h-0">
          <div className="p-3 border-b border-zinc-800">
            <h2 className="text-xs uppercase tracking-widest text-zinc-400 flex items-center gap-2">
              <Sparkles className="w-3 h-3" /> Research
            </h2>
          </div>

          {!activeId ? (
            <div className="p-4 text-xs text-zinc-500">Open a lesson to start researching.</div>
          ) : (
            <ScrollArea className="flex-1">
              <div className="p-3 space-y-3">
                ...
                <div className="pt-3 border-t border-zinc-800 text-[10px] text-zinc-500 leading-relaxed">
                  <strong className="text-zinc-400">How it works:</strong> Highlight text in the editor or type a question, then click Research. The result is inserted as a quoted block at your cursor — your existing prose is never overwritten. Each call is logged to <code className="text-zinc-300">lesson_research</code>.
                </div>
              </div>
            </ScrollArea>
          )}
